    ...
    <footer className="bg-dark text-white/80 pt-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <Link href="/">
              <div className="flex items-center mb-6 cursor-pointer">
                ...
                <span className="font-heading font-bold text-2xl text-white">GEP <span className="text-secondary">Paragliding</span></span>
              </div>
            </Link>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-heading font-semibold text-xl text-white mb-6">Quick Links</h3>
          ...
          {/* Our Services */}
          <div>
            <h3 className="font-heading font-semibold text-xl text-white mb-6">Our Services</h3>
            <ul className="space-y-3">
          ...
          {/* Newsletter */}
          <div>
            <h3 className="font-heading font-semibold text-xl text-white mb-6">Newsletter</h3>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="mb-6">
                <div className="flex">
                  ...
                  <Button 
                    type="submit" 
                    disabled={submitting}
                    className="bg-secondary text-white px-4 py-2 rounded-r-full hover:bg-secondary/90 transition"
                  >
